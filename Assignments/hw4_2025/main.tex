...
{\small\em Version: 1\\Due: 23:59 EST, Apr 7, 2025 on Gradescope\\
}
}
...
\newpage
\begin{enumerate}
%\item \input{Q_taxo_bin} \label{dimen} \clearpage
\item \input{Q_dimension_reduction} \clearpage
\item \input{Q_motif_finding} \clearpage
% \item \input{Q_chip_seq} \label{Chip} \clearpage
\end{enumerate}
